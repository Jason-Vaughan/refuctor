...
Configure Refuctor as an MCP (Model Context Protocol) server in Cursor to enable AI-powered debt detection across all your workspaces.
...
```json
{
  "mcpServers": {
    "refuctor-debt-broker": {
      "command": "node",
      "args": ["/Users/jasonvaughan/Documents/Projects/Refuctor/src/refuctor-mcp-server.js"],
      "env": {},
...
**⚠️ Important**: Update the paths to match your actual Refuctor installation location.
